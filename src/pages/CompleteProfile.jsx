...
function StudentFamilyStep({ onJoin, loading, error }) {
  return (
    <Shell subtitle="Almost there — ask your parent for your family code.">
    ...
    return (
      <Shell subtitle="Your family is ready.">
        ...
        <p className="text-green-300/60 text-sm mb-6">
          Give this code to your kids (and any co-parent) so they can join your family.
      ...
      {mode === 'create' ? (
        <div className="flex flex-col gap-4">
          ...
          <p className="text-green-300/60 text-sm">
            Creates a new family code that you'll share with your kids and any co-parent.
          </p>
          <button
            onClick={onCreate}
            disabled={loading}
        ...
        <JoinFamilyForm onSubmit={onJoin} loading={loading} error={error} label="Family Code (from a co-parent)" />
      )}
    </Shell>
  )
}
...
export default function CompleteProfile() {
  const { userProfile, setUserRole, createFamily, joinFamily } = useAuth()
